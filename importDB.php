...
function creHost($csv_array){
	...
	//ホスト名
	if(! (isset($csv_array[1])) Or $csv_array[1] == "" ){
	...
	//ホストグループ名
	if(! (isset($csv_array[3])) Or $csv_array[3] == "" ){
		echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
	...
	if(! (isset($csv_array[6]))){
       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
       	echo "CSVファイルよりProxy名が取得できませんでした   ID: ${csv_array[11]}<br><br/>";
      		error_log(date("Y/m/d g:i:s")."[ERROR importDB.php crehost] CSVファイルよりProxy名が取得できませんでした   ID: ${csv_array[11]} \n",3,$_LOG);
    }
...
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//        echo "インターフェース名が取得できませんでした<br><br/>";
//    }
	
	//拠点名 type_fullに格納
//	if(! (isset($csv_array[9]))){
//       echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//        echo "拠点名が取得できませんでした<br><br/>";
//    }

	//カスタマ名 nameに格納
//	if(! (isset($csv_array[10]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "カスタマ名が取得できませんでした<br><br/>";
//    }

	//機種名hardwareに格納
//	if(! (isset($csv_array[11]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "機種名が取得できませんでした<br><br/>";
//    }

	//NATIPに格納
//	if(! (isset($csv_array[12]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "NATIPが取得できませんでした<br><br/>";
//    }
	//予備1に格納
//	if(! (isset($csv_array[13]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "予備1が取得できませんでした<br><br/>";
//    }
	//予備2に格納
//	if(! (isset($csv_array[14]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "予備2が取得できませんでした<br><br/>";
//    }
	//予備3に格納
//	if(! (isset($csv_array[15]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "予備2が取得できませんでした<br><br/>";
//    }
	//予備4に格納
//	if(! (isset($csv_array[16]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "予備4が取得できませんでした<br><br/>";
//    }
	//予備5に格納
//	if(! (isset($csv_array[17]))){
//       	echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
//       	echo "予備5が取得できませんでした<br><br/>";
//    }

	//マクロ1
	$macroArray = array();

	if( (isset($csv_array[18]))  and $csv_array[18] != "" ){
		//マクロ1の値
		if(! (isset($csv_array[19]))){
			echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
	...
	//マクロ2
	if( (isset($csv_array[20]))  and $csv_array[20] != "" ){
		//マクロ2の値
		if(! (isset($csv_array[21]))){
			echo "<BR><font color='red' >登録エラー ：" . $svrName . "</font><BR>\n";
	...
	if( count($csv_array) > 27 ){
		...
		for( $i=28; $i< count($csv_array); $i++){
			...
			if( (isset($csv_array[$i]))  && $csv_array[$i] != ""  ){
				
				//マクロの値の取得
				if( (! (isset($csv_array[$i+1]))) || $csv_array[$i + 1] == ""  ){
